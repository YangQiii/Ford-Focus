...
const DROPDOWN_API_ENDPOINT = 'https://ivkdwp85li.execute-api.us-east-1.amazonaws.com/prod'; // TODO
const ML_API_ENDPOINT = 'https://abp8xl8hnk.execute-api.us-east-1.amazonaws.com/prod'; // TODO
...
function App() {
  ...
  return (
    <div className="App">
      ...
      //<object data = "Technical report.pdf"  type="application/pdf" width="750" height="500">
   // </object> 
  </div>
  );
}
